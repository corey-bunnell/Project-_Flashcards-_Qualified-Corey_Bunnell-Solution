      ...
      <form>
        <div className="form-group">
          ...
          <textarea 
            ...
            value={front.front} onChange={handleFront}>
          </textarea>
        </div>
        <div className="form-group">
          ...
          <textarea 
            ...
            value={back.back} onChange={handleBack}>
          </textarea>
        </div>      
        <button 
          type="button"
          className="btn btn-secondary mr-1"
          onClick={handleCancelAndDone}>{isEdit ? "Cancel" : "Done"}
        </button>
        <button 
          type="button"
          className="btn btn-primary"
          onClick={isEdit ? handleUpdate : handleSave}>Save
        </button>
      </form>
    </>
  )
