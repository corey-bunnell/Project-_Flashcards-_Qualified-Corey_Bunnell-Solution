      ...
      <form>
        <div className="form-group">
          ...
          <input 
            ...
            id="name" value={name.name || ''} placeholder={isEdit ? null : "Deck Name"} 
            onChange={handleName} 
          />
        </div>
        <div className="form-group">
          ...
          <textarea 
            ...
            id="description" 
            rows="3" 
            value={description.description || ''} placeholder={isEdit ? null : "Brief Description of Deck"} 
        ...
        <button 
          ...
          onClick={() => 
            history.push(isEdit ? `/decks/${deck.id}` : "/")}>Cancel
        </button>
        <button 
          type="button"
          className="btn btn-primary"
          onClick={isEdit ? handleUpdate : handleCreate}>Submit
        </button>
      </form>
    </>
  )
